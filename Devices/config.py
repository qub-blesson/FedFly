...
HOST2IP = {'mars105U20':'192.168.101.106', 'mars107u20':'192.168.101.107', 'raspberrypi2':'192.168.10.31'}
...
#CLIENTS_CONFIG= {'192.168.10.100':0, '192.168.10.110':1 }
CLIENTS_CONFIG= {'192.168.101.107':0}
...
#CLIENTS_LIST= ['192.168.10.100', '192.168.10.110'] 
CLIENTS_LIST= ['192.168.101.107'] 
...
split_layer = [3,3] #Initial split layers
model_len = 7
